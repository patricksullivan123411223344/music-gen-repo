{
  "patcher": {
    ...
    "boxes": [
      ...
      },
      {
        "box": {
          ...
          "numoutlets": 1,
          "outlettype": [""],
          "patching_rect": [70.0, 122.0, 66.0, 22.0],
          "text": "prepend set"
        }
      },
      {
        "box": {
          ...
          "numoutlets": 1,
          "outlettype": [""],
          "patching_rect": [470.0, 122.0, 110.0, 22.0],
      ...
      },
      {
        "box": {
          ...
          "numoutlets": 1,
          "outlettype": [""],
          "patching_rect": [180.0, 188.0, 110.0, 22.0],
          "text": "prepend setsymbol"
        }
      },
      {
        "box": {
          ...
          "numoutlets": 1,
          "outlettype": [""],
          "patching_rect": [500.0, 188.0, 110.0, 22.0],
          "text": "prepend setsymbol"
        }
      },
      {
        "box": {
          ...
          "numoutlets": 1,
          "outlettype": [""],
          "patching_rect": [180.0, 254.0, 110.0, 22.0],
          "text": "prepend setsymbol"
        }
      },
      {
        "box": {
          ...
          "numoutlets": 1,
          "outlettype": [""],
          "patching_rect": [470.0, 254.0, 110.0, 22.0],
          "text": "prepend setsymbol"
        }
      },
      {
        "box": {
          ...
          "numoutlets": 1,
          "outlettype": ["int"],
          "patching_rect": [160.0, 48.0, 32.0, 22.0],
          "text": "t 1"
        }
      },
      {
    ...
    "lines": [
      ...
      { "patchline": { "source": ["obj-route", 0], "destination": ["obj-hello-tb", 0] } },
      { "patchline": { "source": ["obj-hello-tb", 0], "destination": ["obj-connected", 0] } },
      { "patchline": { "source": ["obj-route", 1], "destination": ["obj-tempo-set", 0] } },
      { "patchline": { "source": ["obj-tempo-set", 0], "destination": ["obj-tempo", 0] } },
      { "patchline": { "source": ["obj-route", 2], "destination": ["obj-inst-set", 0] } },
      { "patchline": { "source": ["obj-inst-set", 0], "destination": ["obj-inst", 0] } },
      { "patchline": { "source": ["obj-route", 3], "destination": ["obj-style-set", 0] } },
      { "patchline": { "source": ["obj-style-set", 0], "destination": ["obj-style", 0] } },
      { "patchline": { "source": ["obj-route", 4], "destination": ["obj-turn-set", 0] } },
      { "patchline": { "source": ["obj-turn-set", 0], "destination": ["obj-turn", 0] } },
      { "patchline": { "source": ["obj-route", 5], "destination": ["obj-trade-set", 0] } },
      { "patchline": { "source": ["obj-trade-set", 0], "destination": ["obj-trade", 0] } },
      { "patchline": { "source": ["obj-route", 6], "destination": ["obj-feel-set", 0] } },
      { "patchline": { "source": ["obj-feel-set", 0], "destination": ["obj-feel", 0] } },
