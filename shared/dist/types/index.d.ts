...
export type SessionPhase = 'idle' | 'backing_only' | 'player_solo' | 'soloist_solo' | 'analysis';
...
export type ApiErrorCode = 'INVALID_CHORD_CHART' | 'INVALID_CONFIG' | 'SESSION_NOT_FOUND' | 'INVALID_PHASE_TRANSITION' | 'WS_SESSION_MISMATCH' | 'INTERNAL_ERROR';
export interface ApiError {
    code: ApiErrorCode;
    message: string;
    details?: Record<string, unknown>;
}
export type ClientMessage = MidiInputMessage | ConfigUpdateMessage | RequestSoloistTurnMessage | RequestPlayerTurnMessage;
...
export type ServerMessage = SessionStateMessage | FormClockTickMessage | BackingTrackReadyMessage | SoloistMidiOutMessage | SoloAnalysisReadyMessage | ErrorMessage;
