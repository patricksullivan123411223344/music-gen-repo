...
export function generateBackingTrack(config) {
    ...
    if (backingInstruments.includes('piano')) {
        ...
        for (let bar = 0; bar < chordChart.barCount; bar++) {
            ...
            notes.push({ pitch: root, velocity: 72, startBeat: beat + 1, durationBeats: 0.4 }, { pitch: root + 4, velocity: 68, startBeat: beat + 1, durationBeats: 0.4 }, { pitch: root + 7, velocity: 68, startBeat: beat + 1, durationBeats: 0.4 });
        }
        parts.push({
            instrument: 'piano',
...
//# sourceMappingURL=BackingTrackService.js.map